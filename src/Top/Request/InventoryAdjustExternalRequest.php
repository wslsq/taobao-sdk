 ...
 */
class InventoryAdjustExternalRequest implements RequestInterface
{
    /**
     ...
     * 商品初始库存信息：
     * [
     * {"scItemId":"商品后端ID，如果有传scItemCode,参数可以为0","scItemCode":"商品商家编码","inventoryType":"库存类型  1：正常,”direction”: 1: 盘盈 -1: 盘亏,参数可选,"quantity":"数量(正数)"}
     * ]
     */
	private $items;
